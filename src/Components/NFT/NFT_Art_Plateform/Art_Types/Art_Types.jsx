...
export default function Art_Types() {
    return <div>
        ...
        <div class="section_solid_Art_type">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="content1">
                            <a href="#" target="_blank">
                                ...
                                <img class="content1-image" src="img_01.png" />
                                <div class="content1-details fadeIn-top textinnerherearttype">
                                    <span>Paintings </span>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="content1">
                            <a href="#" target="_blank">
                                <div class="content1-overlay"></div>
                                <img class="content1-image" src="img_02.png" />
                                <div class="content1-details fadeIn-top textinnerherearttype">
                                    <span>Graffiti </span>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="content1">
                            <a href="#" target="_blank">
                                <div class="content1-overlay"></div>
                                <img class="content1-image" src="img_03.png" />
                                <div class="content1-details fadeIn-top textinnerherearttype">
                                    <span>AR/VR</span>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="content1">
                            <a href="#" target="_blank">
                                <div class="content1-overlay"></div>
                                <img class="content1-image" src="img_04.png" />
                                <div class="content1-details fadeIn-top textinnerherearttype">
                                    <span>3D Art</span>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="content1">
                            <a href="#" target="_blank">
                                <div class="content1-overlay"></div>
                                <img class="content1-image" src="img_05.png" />
                                <div class="content1-details fadeIn-top textinnerherearttype">
        ...
        <section class="section-block-grey">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <img data-src="img-05.png" class="" src="img-05.png" width="100%" />
                    </div>
                    <div class="col-md-7">
                        <div class="box">
