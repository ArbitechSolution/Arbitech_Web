        ...
        <div className="section-block faqSection " id="demo" style={{ padding: "40px 0px" }}>
            <div className="container">
                ...
                <div class="accordion container section-block" id="accordionExample">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingThree">
                            <a class="accordion-button AccourdionAtag collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFoure" aria-expanded="false" aria-controls="collapseThree">
                                <span>Which is an NFT marketplace?</span>

                            </a>
                        </h2>
                        <div id="collapseFoure" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFive">
                            <a class="accordion-button AccourdionAtag collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
