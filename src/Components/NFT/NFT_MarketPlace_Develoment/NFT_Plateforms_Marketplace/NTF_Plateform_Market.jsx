            ...
            <div class="container">
                <div class="row">
                    <div class="section-heading text-center">
                        ...
                        <p>Infinite Block Tech offers meticulous services that will give you a clear idea about our NFT marketplace development services.</p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 text-justify mt-20">
                        ...
                        <p class="expertise">Our foremost priority is to make you the frontrunner in the NFT race by implementing our extensive beneficial features and technical expertise in the NFT platform.</p>
                    </div>

                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 text-center mt-10">
                        <img class="rounded-border shadow-primary" data-src="" src="nft-dev-img-01.png" width="100%" />
                    </div>

                </div>
                <div class="mt-25 text-center btnwhatsandconntechhere">
                    <ReactWhatsapp number="03036954689" message="Hi! I'm interested in one of your products at ARBITECH SOLUTIONS" className="whatsaapherebg mt-4" >
                        <a target="_blank" class="button-md dark-button two-btn">Connect With Whatsapp</a>
                    </ReactWhatsapp>
                    <a href="#contact" class="button-md dark-button two-btn js-scroll-trigger mt-4">Talk to our Experts</a> </div>
            </div>
        </div>
