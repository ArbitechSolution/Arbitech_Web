                ...
                <div class="scroll-toggle">
                    ...
                    <ul class="scroll-toggle__list">
                        <li class="scroll-toggle__list-item">
                            ...
                            <div class="">
                                <div class="nk-block">
                                    <div class="roadmap-wrap roadmap-wrap-ovl-right text-center animated fadeInUp" data-animate="fadeInUp" data-delay="0.3" >
                                        <div class="roadmap-line-s2">
                                                ...
                                                <div class="owl-stage" >
                                                    ...
                                                    <div class="owl-item active" style={{ width: '297.333px', marginRight: '-1px' }}  >
                                                        <div class="roadmap roadmap-s2 roadmap-i3">
                                                            ...
                                                            <h5 class="title title-sm roadmap-date">Sep - Oct 2018</h5>
                                                            <div class="roadmap-text">
                                                    ...
                                                    <div class="owl-item active" style={{ width: '297.333px', marginRight: '-1px' }}  >
                                                        <div class="roadmap roadmap-s2 roadmap-i4">
                                                            ...
                                                            <h5 class="title title-sm roadmap-date">Nov - Dec 2018</h5>
                                                            <div class="roadmap-text">
                                                                <p>Launch of the mobile Best versions of the Publisher application and Press Tour.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="owl-item" style={{ width: '297.333px', marginRight: '-1px' }}  >
                                                        <div class="roadmap roadmap-s2 roadmap-i5">
                                                            <h6 class="roadmap-year-s2">Q1 2019</h6>
                                                            <h5 class="title title-sm roadmap-date">Jan - Apr 2019</h5>
                                                            <div class="roadmap-text">
                                                    ...
                                                    <div class="owl-item" style={{ width: '297.333px', marginRight: '-1px' }} >
                                                        <div class="roadmap roadmap-s2 roadmap-i6">
                                                            ...
                                                            <h5 class="title title-sm roadmap-date">Jul - Aug 2019</h5>
                                                            <div class="roadmap-text">
                                                                <p>Creation of a decentralize martketplace to neural network adjacent coefficients.</p>
                                                            </div>
                                                        </div>
                    ...
                    <div class="owl-nav">
                        ...
                        <button type="button" role="presentation" className="owl-prev   scroll-toggle__button scroll-toggle__button--left"></button>
                        <button type="button" role="presentation" className="owl-next  scroll-toggle__button scroll-toggle__button--right"></button>
                    </div>
