                    ...
                    <div className="col-md-6 mob-left">
                        <div className="section-heading">
                            ...
                            <ul>
                                ...
                                <li>Borrowers can get fiat loans from lenders and if they fail to repay it, their crypto assets will act as the collateral. </li>
                                <li>The interest rate will be accepted by the borrower and the lender. </li>
                                <li>The smart contract will dictate all the terms and conditions of the loan. There are no third parties in the system. </li>
                                <li>Both parties have to agree to the terms issued. The operations can be stopped only if both the parties mutually allow it. </li>
                                <li>If the loan is repaid by the borrower, the lender will release the collateral that acted as the security. </li>
                                <li>The lenders have a great opportunity to earn high returns and assess their risks owing to the transparent and immutable blockchain network. </li>
                                <li>The overall operating costs are significantly reduced due to the interoperability and standardization of the DeFi lending and borrowing platform.</li>
                                <li>The entire system is permissionless and end-to-end encrypted.</li>
                                <li>The benefits include utmost transparency, price efficiency, flexibility, and rewards for long-term investment. </li>
                            </ul>
                        </div>
                    </div>
