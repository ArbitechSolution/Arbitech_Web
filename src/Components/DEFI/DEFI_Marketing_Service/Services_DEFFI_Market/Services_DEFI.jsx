...
import './Services_Defi_Market.css'

export default function Services_DEFI() {
    return (
        <div>
            <div className="section-block">
                <div className="container">
                    <div className="section-heading center-holder">
                        <h2>Our DeFi Marketing Services</h2>
                    ...
                    <div className="row mt-50">
                        ...
                        <div className="card101">
                            ...
                            <div className="row features-benifit">
            ...
            <div className="section-block cta_wrapper">
                <div className="container">
                    <div className="section-heading center-holder">
                        <h2 className="white-text">Get A Personalized Defi Marketing Plan  </h2>

                        <p className="white-text">A well-devised plan to get your business list among the top market players. One of the leading DeFi marketing companies in town!</p>
                    </div>
                    <div className="mt-25 text-center">

                        <a href="#contact" className="button-md dark-button two-btn js-scroll-trigger">Request a free plan</a>
                    </div>
                </div>
            </div>
            ...
            <div className="section-block section-block-grey">
                <div className="container">
                    <div className="section-heading center-holder">
                        <h3>Robust Setup Plans For DeFi Businesses</h3>
                        <div className="section-heading-line"></div>
                    </div>
                            ...
                            <ul>
                                <li className='lihermtop'>
                                    <span>
                                        ...
                                        <img className="" data-src="management.svg" src="management.svg" width="100%" />
                                    </span>
                                    <div className="cnt101">
                                        <h4>DeFi Business Setup</h4>
                                        <p>Outlining the DeFi business model, token concept, and the financial setup. Creating all documents, including pitch deck, whitepaper, business collaterals, and more, needed to launch a credible DeFi business and validating them for certainty.</p>
                                        <a href="#contact" className="button-md dark-button two-btn js-scroll-trigger">Request a proposal</a>
                                    </div>
                                </li>
                                <li className='lihermtop'>
                                    <span>
                                        <div className="count101">2</div>
                                        <img className="" data-src="settings.svg" src="settings.svg" width="100%" />
                                    </span>
                                    <div className="cnt101">
                                        <h4>DeFi Legal Setup</h4>
                                        <p>Complete review of the documents created for the DeFi business like pitch deck, whitepaper, etc. Sharing legal views with regards to token authenticity and licensing, </p>
                                        <a href="#contact" className="button-md dark-button two-btn js-scroll-trigger">Request a proposal</a>
                                    </div>
                                </li>
                                <li className='lihermtop'>
                                    <span>
                                        ...
                                        <img className="" data-src="strategy.svg" src="strategy.svg" width="100%" />
                                    </span>
                                    <div className="cnt101">
                                        <h4>DeFi Marketing Solutions</h4>
                                        <p>Deploying a range of marketing efforts - business listing, social media marketing, email marketing, Public Relations (PR), community management, landing page development, paid advertising, and a lot more.</p>
                                        <a href="#contact" className="button-md dark-button two-btn js-scroll-trigger">Request a proposal</a>
                                    </div>
                                </li>
                            </ul>
