...
import './Benefits_ido.css'
import ReactWhatsapp from 'react-whatsapp';


export default function Benefits_IDo() {
  return (
    <div>

    <div className="section-block-grey benefitSec">
        <div className="container sto-ben">
            <div className="center-holder section-heading">
                <h3>Benefits Of Initial Dex Offering Development Platform</h3>
                <div className="section-heading-line"></div> 
            </div>
            <div className="row mt-50">
                <div className="col-xs-12 col-md-6 col-sm-6 mt-5">
                    <div className="feature-flex-square0101">
    ...
    <div className="section-block section-block-grey">
        <div className="container">
            <div className="section-heading center-holder">
                <h2>Our Services To Launching Your IDO Development Platform</h2>
                <div className="section-heading-line"></div>
            ...
            <div className="row adv_ft mt-30">
                ...
                <div className="col-xs-12 col-sm-6 col-md-4">
                    <div className="exchange-box number-box">
                        <h3><img className="" data-src="paper.svg" src="paper.svg"/></h3>
                        <div className="number-box-line"></div>
                        <h4>Whitepaper Drafting</h4>
                        <p className="services-txt">We introduce your project to the crypto market by providing a detailed and comprehensive whitepaper service.</p>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-4">
                    <div className="exchange-box number-box">
                        <h3><img className="" data-src="road-map.svg" src="road-map.svg"/></h3>
                        <div className="number-box-line"></div>
                        <h4>Strategy And Roadmap</h4>
                        <p className="services-txt">We provide strategic based roadmaps which are used to visualize the trajectory of the project and it helps in securing stakeholders.</p>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-4">
                    <div className="exchange-box number-box">
                        <h3><img className="" data-src="setting.svg" src="setting.svg"/></h3>
                        <div className="number-box-line"></div>
                        <h4>Coin Development</h4>
                        <p className="services-txt">We provide proven and trusted solutions for customized, secure token development services.</p>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-2"></div>
                <div className="col-xs-12 col-sm-6 col-md-4">
                    <div className="exchange-box number-box">
                        <h3><img className="" data-src="bullhorn.svg" src="bullhorn.svg"/></h3>
                        <div className="number-box-line"></div>
                        <h4>Marketing</h4>
                        <p className="services-txt">We initiate a detailed marketing strategy for your project and design marketing solutions to acquire better market visibility.</p>
                    </div>
                </div>
                <div className="col-xs-12 col-sm-6 col-md-4">
                    <div className="exchange-box number-box">
                        <h3><img className="" data-src="computer.svg" src="computer.svg"/></h3>
                        <div className="number-box-line"></div>
                        <h4>Blockchain Integration</h4>
                        <p className="services-txt">We provide standardization and automation across various industries with customized integration of blockchain technology.</p>
                    </div>
                </div>
