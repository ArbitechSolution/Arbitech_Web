...
export default function Home_IDO() {
    return (
        <div>
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-sm-12 col-md-7">
                            ...
                            <div className="mt-40 intro_cnt text-left754">
                                ...
                                <p >The evolution of blockchain technology has taken the fundraising process to the top echelon. All companies are planning to raise funds using the following models ICO, STO, ILO and IDO.</p>

                                <p >In Initial Dex Offering (IDO), the projects receive funds from the investors in a similar fashion to the traditional startups that receive funds from venture capitals. In IDO, the investors will not have the power to own any shares or equity in the project.</p>
                    ...
                    <div className="row mt-50">
                        <table width="80%" cellpadding="10" style={{margin: "0 auto" , boxShadow: "5px 5px 16px 8px #00000024"}}>
                            <tbody><tr>
                                ...
                                <th>Security Token Offering(STO)</th>
                                <th>Initial Exchange Offering(IEO)</th>
                            </tr>
                                <tr>
                                    <td>Decentralised exchange</td>
                                    <td>Decentralised</td>
