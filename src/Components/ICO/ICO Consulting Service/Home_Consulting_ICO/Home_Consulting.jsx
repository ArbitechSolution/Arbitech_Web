...
import './Home_Cosulting.css'

export default function Home_Consulting() {
    return (
        <div>


            <div class="swiper_slide_Consulting">
                <div class="sec-overlay"></div>
                <div class="container">
                    <div class="slider-content text-left">
                        <div class="row ror_here_home">
                            <div class="col-xs-12 col-md-7 col-sm-7 ror_here_home">
                                <h1 class="animated fadeInDown">ICO Consulting Services</h1>
                                <p class="animated fadeInDown w-100%">Seeking substantial funds for your venture? Team up with our premium strategic analysts and market experts to achieve the most credible <strong>ICO consulting services</strong> from ideation to implementation! </p>
                                <div class="animated fadeInUp mt-30 ror_here_home">
                                    <a href="#contact" class="button-md dark-button two-btn js-scroll-trigger">Talk to Our Experts</a>

                                </div>
                            </div>
                            <div class="col-xs-12 col-md-5 col-sm-5 mt-4">
                                <div class="banner-img">
                                    <img data-src="banner-img321.png" width="100%" class="" src="banner-img321.png" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-block-grey ico-consulting">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                            <div class="pr-30-md">
                                <div class="section-heading text-left">
                                    <h4>What Is Meant By ICO Consultation?</h4>
                                </div>
            ...
            <div class="section-block ico-consulting essential-sec">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5   text-center">
                            <div class="full-width mt-15-xs video-video-box">
                                ...
                                <div itemscope="" itemtype="https://schema.org/ImageObject">
                                    ...
                                    <img src="essential.png" class="img-responsive imgeshere" width="100%" alt="ICO Consulting" itemprop="contentUrl" />
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                            <div class="pr-30-md">
                                <div class="section-heading text-left">
                                    <h4>Why Are ICO Consulting Services Essential ?</h4>
                                </div>
                                <div className='line_non_fungible_center'>
                                ...
                                <div class="mt-20 text-content text-left">
                                    <p>With the increased popularity and competition for ICOs and evolving ICO regulations, there is only a thin line between the success and failure of an ICO. There are many ICOs that have failed to sustain in the past due to a lack of proper strategy and planning. Therefore, it is essential to completely analyze and understand the market trends and requirements, and create an ICO that attracts the investors. For that purpose, seeking ICO consultation services from experts will be extremely helpful.  </p>
                                    <p> Also, for a novice crypto entrepreneur, it might be overwhelming to keep with the constantly changing regulations and market trends. Therefore, hiring an experienced team of ICO consultants will make the whole process convenient for them. On the other hand, ICO consulting services benefit not only novice entrepreneurs but also existing ICO projects to further enhance their strategies to gain better results. </p>
                                </div>
                            </div>
                        </div>
