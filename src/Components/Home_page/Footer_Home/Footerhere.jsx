            ...
            <div className="footer-top row">
                ...
                <div className="col-md-6 text-right foot-right">
                  ...
                  <ReactWhatsapp number="03036954689" message="Hi! I'm interested in one of your products at  Arbitech SOLUTIONS" className="bgherefooter" >
                    ...
                    <li><a rel="nofollow" href="#" target="_blank"><i className="fab fa-skype"></i></a></li>
                    <li><a rel="nofollow" href="# " target="_blank"><i className="fab fa-facebook-f"></i></a></li>
                    <li><a rel="nofollow" href="# " target="_blank"><i className="fab fa-twitter"></i></a></li>
