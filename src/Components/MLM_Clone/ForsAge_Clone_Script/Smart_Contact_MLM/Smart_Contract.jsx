    ...
    return (
        <div>
            ...
            <div className="section-block section-block-grey">
                <div className="container">
                    <div className="section-heading center-holder">
                        <h2>Benefits of Starting a Smart Contract MLM like Forsage</h2>
                        <p>Create A Profitable Business Using A Smart Contract MLM like Forsage</p>
                    ...
                    <div className="row mt-50">
                        <div className="col-md-6 text-left">
                            ...
                            <ul className="primary-list">
                                ...
                                <li><i className="fa fa-check-square"></i> Zero security risk as this platform is backed by blockchain technology</li>
                            </ul>
                        </div>
                        <div className="col-md-6 mt-2">
                            <img className="mb-10 rounded-border shadow-primary img_Here_Forsage mt-5" data-src="smart-contract.jpg" src="smart-contract.jpg" />
                        </div>
            ...
            <div className="section-block">
                <div className="container">
                    <div className="section-heading center-holder">
                        <h2>Steps to Launch Smart Contract MLM Platform</h2>
                        <div className="section-heading-line"></div>
                        ...
                        <div className="col-md-12 mt-5 ">
                            <div className="work_flow">
                                ...
                                <div className="flow_diag">
                                    ...
                                    <div className="flow_diag-content">
                                        <h6 className='p_Safe_Mood text-center'>Use our developer team to customize the MLM smart contract according to your business needs</h6>
                                    </div>
                                    <div className="border"></div>
                                </div>
                                <div className="flow_diag">
                                    ...
                                    <div className="flow_diag-content">
                                        <h6 className='p_Safe_Mood text-center'>Next, attach the extra features that you have in mind to make the platform more interactive and exciting.</h6>
                                    </div>
                                    <div className="border"></div>
                                </div>
                                <div className="flow_diag">
                                    ...
                                    <div className="flow_diag-content">
                                        <h6 className='p_Safe_Mood text-center'>Finally, launch the Forsage MLM clone and watch it scale in size as well as profits.</h6>
                                    </div>
                                    <div className="border"></div>
                                </div>
                            </div>
            ...
            <div className="section-block section-block-grey">
                <div className="container">
                    <div className="section-heading center-holder">
                        <h2>Why Start Smart Contract based<br/> Cryptocurrency MLM Business like Forsage?</h2>
                        <p>Run A Profitable Business Using Smart Contract-based Cryptocurrency MLM Script Like Forsage</p>
                        <div className="section-heading-line"></div>
                    </div>
                    <div className="row mt-50">
                        <div className="col-md-5">
                            <img className="mb-10 rounded-border shadow-primary img_Samat_Contract_here" data-src="Cryptocurrency-MLM-Business.jpg" src="Cryptocurrency-MLM-Business.jpg"   />
                        </div>
                        <div className="col-md-7 text-left mt-2">
                            ...
                            <ul className="primary-list ms-4">
                                <li><i className="fa fa-check-square"></i> Low investment threshold</li>
                                <li><i className="fa fa-check-square"></i> Potential to earn huge revenues</li>
                                <li><i className="fa fa-check-square"></i> Absolute transparency in operations</li>
                                <li><i className="fa fa-check-square"></i> Direct P2P commission disbursements</li>
                                <li><i className="fa fa-check-square"></i> Participate in the crypto-economy</li>
                                <li><i className="fa fa-check-square"></i> Zero scam due to smart contract functionality</li>
                                <li><i className="fa fa-check-square"></i> Highly secure platform backed by blockchain technology</li>
                            </ul>
                        </div>
                    </div>
                </div>
