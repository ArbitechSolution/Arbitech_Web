...
import './Home_Forsage_script..css'
import ReactWhatsapp from 'react-whatsapp';


export default function Home_MLM_Forsage() {
    return (
        <div>
            <div className="swiper_slide_Forsage" >
                <div className="sec-overlay454"></div>
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-sm-12 col-md-6 mt-5">
                            <div className="section-heading left_tti">
                                <h2>Forsage Clone Software</h2>
                                <div className="section-heading-line"></div>
                            </div>
                            <div className="mt-40 intro_cnt text-left7412">
                                <p className=''>Forsage Clone Software is a robust and whitelable MLM product. Using a self-executing Ethereum smart contract, you can launch and manage a decentralized MLM company similar to forsage.io.</p>
                    ...
                    <div className="row mt-50">
                        <div className="col-md-6">
                            <ul className="primary-list">
                                <li><i className="fa fa-check-square"></i> Simple and low-risk way to earn profit</li>
                                <li><i className="fa fa-check-square"></i> Customizable Matrix schemes</li>
                                <li><i className="fa fa-check-square"></i> Decentralized and direct commission distribution framework</li>
                                <li><i className="fa fa-check-square"></i> Smart contracts automate the process and eliminate the risk of scams</li>
                                <li><i className="fa fa-check-square"></i> Blockchain-backed system for transparency and trust</li>
                                <li><i className="fa fa-check-square"></i> Quickest and safest way to build wealth</li>
                                <li><i className="fa fa-check-square"></i> Supports Peer-to-Peer payments</li>
                                <li><i className="fa fa-check-square"></i> Efficient MLM crowdfunding network</li>
                            </ul>
                        </div>
                        <div className="col-md-6">
                            <img className="rounded-border shadow-primary img_Here_Forsage" src="Benefits-of-Forsage-Clone.jpg" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="section-block section-block-grey">
                <div className="container">
                    <div className="section-heading center-holder">
                        <h2>How Forsage Smart Contract MLM Works?</h2>
                        <p>Easy-to-use Forsage Smart Contracts</p>
                        <div className="section-heading-line"></div>
                    </div>
                    <div className="row mt-20">

                        <div className="col-xs-12 col-sm-6 col-md-6">
                            <div className="full-width peer-to-img mt-4">
                                <img alt="img" data-src="How-Forsage-Smart-Contract.jpg" className="mb-10 rounded-border shadow-primary  img_Here_Forsage" src="How-Forsage-Smart-Contract.jpg" />
                            </div>
                        </div>
                        <div className="col-xs-12 col-sm-6 col-md-6">
                            <div className="pr-30-md">
                                ...
                                <div className="mt-20 text-content text-left">
                                    ...
                                    <div className="col-md-6 ms-4">
                                        <ul className="primary-list">
                                            <li><i className="fa fa-check-square"></i> Trust Wallet</li>
                                        </ul>
                                    </div>
                                    <div className="col-md-6 ms-4">
                                        <ul className="primary-list">
                                            <li><i className="fa fa-check-square"></i> MetaMask</li>
                                        </ul>
                                    </div>

                                    <p>When setting up their accounts, users can set their preferences and receive rewards directly to their wallet.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="section-block">
                <div className="container">
                    ...
                    <div className="row mt-20 mt-5">
                        ...
                        <div className="col-xs-12 col-sm-6 col-md-6">
                            <div className="full-width peer-to-img">
                                <img alt="img" data-src="Launch-your-Smart-Contract-based.jpg" className="mb-10 rounded-border shadow-primary img_Here_Forsage" src="Launch-your-Smart-Contract-based.jpg" /></div>
                        </div>
                        <div className="col-xs-12 col-sm-6 col-md-6">
                            <div className="pr-30-md">
