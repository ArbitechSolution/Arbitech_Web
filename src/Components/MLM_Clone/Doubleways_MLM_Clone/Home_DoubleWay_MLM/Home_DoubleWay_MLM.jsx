...
import './Home_Style_MLM_Doubkle.css'
import ReactWhatsapp from 'react-whatsapp';


export default function Home_DoubleWay_MLM() {
  return (
    <div>
    <div className="swiper_slide_DoubleWay" >
        ...
        <div className="container">
             <div className="row">
                ...
                <div className="col-xs-12 col-sm-12 col-md-6 text-center">
                    <img className="rounded-border shadow-primary img_Here_Forsage" data-src="doubleway-clone-script.jpg" src="doubleway-clone-script.jpg"/>
                </div>
        ...
        <div className="container">
            ...
            <div className="row mt-50">
                <div className="col-md-6 mt-5">
                    <img className="rounded-border" src="impeccable-features-of-our-doubleway-clone-script.png"/>
                </div>
                <div className="col-md-6">
                    <ul className="primary-list">
                        <li><i className="fa fa-check-square"></i> True Decentralization </li>
                        <li><i className="fa fa-check-square"></i> Implemented with Binary 2x8 Matrix strategy</li>
                        <li><i className="fa fa-check-square"></i> Ethereum smart contract based functionality</li>
                        <li><i className="fa fa-check-square"></i> Capacity to handle 5000 ETH transactions per hour </li>
                        <li><i className="fa fa-check-square"></i> Completely automated, speedy transactions</li>
                        <li><i className="fa fa-check-square"></i> Completely secure and hack-proof </li>
                        <li><i className="fa fa-check-square"></i> Peer to peer payment system</li>
                        <li><i className="fa fa-check-square"></i> Efficient referral sharing links</li>
                        <li><i className="fa fa-check-square"></i> Immutable data and transactions</li>
                        <li><i className="fa fa-check-square"></i> Metamask wallet support</li>
                        <li><i className="fa fa-check-square"></i> No Manual Intervention</li>
                        <li><i className="fa fa-check-square"></i> Maximum returns with minimum investment</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div className="section-block section-block-grey">
        <div className="container">
            <div className="section-heading center-holder">
                <h2>How To Start a Smart Contract MLM Like Doubleway ?</h2>
                <p>To get started with a secure and successful smart contract MLM platform like Doubleway, these are the steps you need to carefully consider, </p>
                <div className="section-heading-line"></div>
            </div>
            <div className="row mt-50">
                <div className="col-md-7">
                    <ul className="primary-list">
                        <li><i className="fa fa-check-square"></i> Focus on figuring out your USP( Unique Selling Proposition) i.e how your smart contract MLM is different from the competitors and what are the added benefits it brings in, to attract potential customers towards your platform. </li>
                        <li><i className="fa fa-check-square"></i> Carefully research, analyze and compute a strategic plan and ROI structure for your smart contract MLM platform, and the smooth workflow of your platform to make it user-centric. </li>
                        <li><i className="fa fa-check-square"></i> Implement proper mathematical algorithms to elevate potential, productivity profitability of your smart contract-based MLM platform.</li>
                        <li><i className="fa fa-check-square"></i> Decide the level, whether it is binary or unilevel or anything else.</li>
                        <li><i className="fa fa-check-square"></i> Ensure authentic smart contracts development, auditing and deployment for seamless automated functioning.</li>
                        <li><i className="fa fa-check-square"></i> Ensure the feasibility of implementing your project idea into the smart contract.</li>
                        <li><i className="fa fa-check-square"></i> Ensure proper functionality of the platform before going live.</li>
                        <li><i className="fa fa-check-square"></i> Concentration on the customization part to achieve an individual recognition over your wide-spread competitors in the market.</li>
                    </ul>
                </div>
                <div className="col-md-5">
                    <img className="mb-10 rounded-border shadow-primary img_Here_Forsage" data-src="how-to-start-a-smart-contract-mlm-like-doubleway.jpg" src="how-to-start-a-smart-contract-mlm-like-doubleway.jpg"/>
                </div>
